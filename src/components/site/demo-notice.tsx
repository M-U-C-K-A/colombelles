 ...
 * toucher. Le paragraphe est toujours présent dans le document et rattaché au
 * bouton par `aria-describedby` : il est donc restitué par les lecteurs
 * d'écran même sans ouvrir le panneau, où le survol n'existe pas.
 */
  ...
  return (
    ...
    >
      <div
        ...
        role="note"
        className={cn(
          "absolute right-0 bottom-full mb-2.5 w-[19rem] border border-foreground bg-background p-5 text-left shadow-[0_20px_44px_-24px_rgba(0,0,0,0.55)] transition-all duration-150 sm:w-[23rem]",
          open
